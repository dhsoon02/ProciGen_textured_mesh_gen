...
# adapted By Xianghui from psbody.mesh library, see: https://github.com/MPI-IS/mesh/blob/master/mesh/serialization/serialization.py
...
def load_from_file(self, filename, use_cpp=False):
    "load from cpp does not work well, always use python loading"
